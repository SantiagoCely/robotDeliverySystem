...
import os
import rospy
from fds_hlc.srv import SaveWaypoint, SaveWaypointRequest, SaveWaypointResponse
...
class SaveWaypointClass():
    def __init__(self, init_check_for_waypoints=True, new_markers=False):
    ...
    def init_saved_waypoints_dict(self):
        ...
        rospy.loginfo("inside init_saved_waypoints_dict")
    ...
    def add_waypoint_to_dict(self, name, waypoint):
        rospy.loginfo("inside add_waypoint_to_dict")
        """
    ...
    def get_waypoint_dict(self):
        rospy.loginfo("inside get_waypoint_dict")
        return self._saved_waypoints_dict

    def save_waypoint_callback(self, request):
        rospy.loginfo("inside save_waypoint_callback")
        """
    ...
    def load_waypoints_file(self):
        rospy.loginfo("inside load_waypoints_file")
        """
    ...
    def save_waypoints_file(self):
        rospy.loginfo("inside save_waypoints_file")
        """
    ...
    def _update_newest_waypoint(self):
        rospy.loginfo("inside _update_newest_waypoint")
    ...
    def _load_file_waypoints_into_markers(self):
        rospy.loginfo("inside _load_file_waypoints_into_markers")
        """
    ...
    def add_new_marker(self, name, waypoint_position):
        rospy.loginfo("inside add_new_marker")
        """
    ...
    def _check_marker_publishers_connection(self):
        rospy.loginfo("inside _check_marker_publishers_connection")
        """
    ...
    def init_markers(self):
        rospy.loginfo("inside init_markers")
...
if __name__ == '__main__':
    ...
    try:
        SaveWaypointClass(new_markers=True)
        rospy.spin()
    except rospy.ROSInterruptException:
